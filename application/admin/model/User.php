...
class User extends Model
{
   ...
   public function addadmin($data){
    ...
    if($this->save($adminData)){
        ...
        db('user_group_access')->insert($groupAccess);
        return true;
    }else{
        return false;
    }
   ...
   public function getadmin(){
    return $this::where('status',1)->paginate(5,false,[
        'type'=>'boot',
        'var_page' => 'page',
        ]);
   }
   ...
   public function saveadmin($data,$admins){
        ...
        db('user_group_access')->where(array('uid'=>$data['id']))->update(['group_id'=>$data['group_id']]);
